...
//	public WebElement homesForSaleLink;
	...
	public boolean isAt() {
		return Driver.getDriver().getTitle().equals("Trulia: Real Estate Listings, Homes For Sale, Housing Data");
	}

	public boolean isUrl() {
		return Driver.getDriver().getCurrentUrl().equals("https://www.trulia.com/");
	}
